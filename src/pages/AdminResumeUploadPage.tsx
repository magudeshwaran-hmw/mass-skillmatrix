...
⚠️ STRICT DEFINITION: An achievement is ONLY one of these:
  ✅ Named awards: Pegasus, Gold Award, Silver Award, Bronze Medal, Best Team Award, Star Award, etc.
  ...
  ✅ Certifications used as awards (only if listed under Awards/Recognition section)

❌ DO NOT extract these as achievements:
  ...
  ❌ Anything that is a project result/KPI/metric — NOT an award
...
- Pegasus → extract as achievement
- Gold → extract as achievement
- Silver → extract as achievement
- Kaggle Bronze Medal → extract as achievement
...
❌ "Improved data quality by 15%" → DO NOT extract (this is a metric)
❌ "Reduced false positive rate" → DO NOT extract (this is a metric)

PLACE 3: "Any client appreciation" subsection in EACH project
✅ "Appreciated by client for quality and timely delivery" → extract
✅ "Received client appreciation" → extract
...
IF THE RESUME HAS NO AWARDS SECTION AND NO NAMED AWARDS IN PROJECTS → return empty achievements array []
...
Count the number of awards in "Awards" section plus "Major achievements" subsections. That is how many achievements you should extract.
